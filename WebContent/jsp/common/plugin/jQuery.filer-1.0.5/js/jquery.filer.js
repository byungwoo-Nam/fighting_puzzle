...
var FilerInput = {
	puzzleUpload : '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-folder"></i></div><div class="jFiler-input-text"><h3>사진을 선택해 주세요.</h3></div></div></div>'	
}
